/**
 * Wenshu desktop plugin template. Save as:
 *   <wenshu home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <wenshu home> is ~/.wenshu by default, or ~/.wenshu-hermes/profiles/<name>
 * when running a named profile (`wenshu -p <name>`). Run `wenshu doctor` (or
 ...
 * Only these imports resolve: @wenshu/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@wenshu/plugin-sdk'
