...
| | |
|---|---|
| Source | Optional — install with `wenshu skills install official/health/neuroskill-bci` |
...
Connect Wenshu to a running [NeuroSkill](https://neuroskill.com/) instance to read
