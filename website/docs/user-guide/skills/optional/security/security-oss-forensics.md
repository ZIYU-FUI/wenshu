...
| | |
|---|---|
| Source | Optional — install with `wenshu skills install official/security/oss-forensics` |
...
> resolve `SKILL_DIR` to the actual path — e.g. `~/.wenshu-hermes/skills/security/oss-forensics/`
