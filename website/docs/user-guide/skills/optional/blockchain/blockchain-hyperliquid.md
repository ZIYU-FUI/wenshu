...
| | |
|---|---|
| Source | Optional — install with `wenshu skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Wenshu Agent |
| License | MIT |
...
The script reads `${WENSHU_HOME:-~/.wenshu}/.env` for two optional defaults:
...
Helper script: `~/.wenshu-hermes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.wenshu-hermes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${WENSHU_HOME:-~/.wenshu}/.env`.
...
```bash
python3 ~/.wenshu-hermes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.wenshu-hermes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
