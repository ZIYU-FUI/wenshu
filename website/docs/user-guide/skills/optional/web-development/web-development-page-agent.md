...
- User wants **Wenshu itself to drive a browser** → use Wenshu' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
