...
| | |
|---|---|
| Source | Optional — install with `wenshu skills install official/productivity/shopify` |
...
4. Save to `${WENSHU_HOME:-~/.wenshu}/.env`:
   ```
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Wenshu","productType":"Apparel","tags":["test"]}}'
```
