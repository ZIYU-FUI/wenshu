...
| | |
|---|---|
| Source | Optional — install with `wenshu skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Wenshu Agent |
| License | MIT |
...
```
SCRIPT=~/.wenshu-hermes/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.wenshu-hermes/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
