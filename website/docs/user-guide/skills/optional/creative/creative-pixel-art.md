...
| | |
|---|---|
| Source | Optional — install with `wenshu skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.wenshu-hermes/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.wenshu-hermes/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Wenshu installs package this)
