...
| | |
|---|---|
| Source | Optional — install with `wenshu skills install official/research/qmd` |
...
Wenshu Agent via the native MCP client. This is the preferred
...
Then configure Wenshu Agent to connect via HTTP:
