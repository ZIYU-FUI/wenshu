...
| | |
|---|---|
| Source | Optional — install with `wenshu skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Wenshu Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $WENSHU_OSINT_CACHE/icij/ (default: ~/.cache/wenshu-osint/icij/).
...
# Set WENSHU_OSINT_UA=your-app/1.0 (your@email) to identify yourself
