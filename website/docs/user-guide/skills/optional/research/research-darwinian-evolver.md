...
| | |
|---|---|
| Source | Optional — install with `wenshu skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Wenshu Agent |
| License | MIT |
...
import upstream classes into Wenshu itself.
...
```bash
mkdir -p ~/.wenshu-hermes/cache/darwinian-evolver && cd ~/.wenshu-hermes/cache/darwinian-evolver
...
```bash
cd ~/.wenshu-hermes/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.wenshu-hermes/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.wenshu-hermes/skills/research/darwinian-evolver
DE_DIR=~/.wenshu-hermes/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Wenshu core.
   Custom driver scripts under `~/.wenshu-hermes/skills/...` are user-side and fine.
