...
| Related skills | [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`wenshu-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-wenshu-agent) |
...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Wenshu terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Wenshu itself, `model.provider: openai-codex` uses Wenshu-managed Codex
OAuth from `~/.wenshu-hermes/auth.json` after `wenshu auth add openai-codex`. For the
