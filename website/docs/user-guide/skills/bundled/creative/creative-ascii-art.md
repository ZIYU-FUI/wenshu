...
```bash
python3 -m pyfiglet "WENSHU" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=WENSHU&font=Slant" | boxes -d stone
```
