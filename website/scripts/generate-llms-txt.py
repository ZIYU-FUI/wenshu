#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Wenshu docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Wenshu as a Python Library", None),
        ("guides/use-mcp-with-wenshu", "Use MCP with Wenshu", None),
        ("guides/use-voice-mode-with-wenshu", "Use Voice Mode with Wenshu", None),
        ("guides/use-soul-with-wenshu", "Use SOUL.md with Wenshu", None),
        ("guides/build-a-wenshu-plugin", "Build a Wenshu Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Wenshu"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "wenshu-agent/main/scripts/install.sh | bash`  "
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Wenshu Agent — Full Documentation\n",
        (
            "This file is the entire Wenshu Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Wenshu, Features, Messaging, Integrations, Guides, "
