#!/usr/bin/env python3
"""
SWE Runner with Wenshu Trajectory Format

A runner that uses Wenshu-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Wenshu-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Wenshu-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Wenshu format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Wenshu-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Wenshu-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Wenshu Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Wenshu-Agent's built-in execution environments
    and outputs trajectories in Wenshu-Agent format.
    """
    ...
    def _convert_to_wenshu_format(
        ...
        """
        Convert internal message format to Wenshu trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Wenshu trajectory format
        trajectory = self._convert_to_wenshu_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Wenshu trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Wenshu Trajectory Format")
    print("=" * 60)
