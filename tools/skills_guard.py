...
Trust levels:
  - builtin:   Ships with Wenshu. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.wenshu-hermes/\.env|\~/\.wenshu-hermes/\.env',
     "wenshu_env_access", "critical", "exfiltration",
     "directly references Wenshu secrets file"),
    ...
    (r'\.wenshu-hermes/config\.yaml|\.wenshu-hermes/SOUL\.md',
     "wenshu_config_mod", "critical", "persistence",
     "references Wenshu configuration files directly"),
...
# scan. `.skillignore` is the Wenshu-native name; `.clawhubignore` is honored
