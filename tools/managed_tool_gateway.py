...
def auth_json_path():
    """Return the Wenshu auth store path, respecting WENSHU_HOME overrides."""
    return get_wenshu_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`wenshu tools`, banner/status paint, provider
