...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of NousResearch/wenshu-agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of NousResearch/wenshu-agent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (NousResearch/wenshu-agent#67052). ``ok`` stays
