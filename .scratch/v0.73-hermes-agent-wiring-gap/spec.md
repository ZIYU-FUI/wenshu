...
| `WebSearch` | **Wire** (= scope of v0.73, scope-limited) | Boss 9/4 OOB 'A' approved 5-provider rotation + research convenience; today's `web` Tool is fetch-only markdown (= single-provider, no rotation, no research pipeline) | issue 003 |
