# Issue 12 — M5/M6 hermes verbatim-port — entity extraction
...
确定性正则 entity 提取器 (= 中文引号识别 + 角色名 + 地名 + 概念) — 代替现有 ChatTrigger CN-quoted regex

## From hermes

```
plugins/memory/holographic/store.py::_extract_entities (L448-481)
```
...
M5 entity extraction ticket 落地时
