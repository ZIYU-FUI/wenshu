# Issue 13 — M5/M6 hermes verbatim-port — smart query rewriter
...
LLM query rewriter + trivial-prompt gate (= 简单查询直接 eval, 复杂查询先 rewrite) — 代替现有 SmartQueryEvaluator direct-eval 路径

## From hermes

```
plugins/memory/query_rewrite.py (139 LOC) + agent/memory_provider.py::TRIVIAL_PROMPT_RE gate
```

## To wenshu

```
Sources/WenshuApp/Domain/SmartQueryRewriter.swift
```
