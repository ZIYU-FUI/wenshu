...
struct ChatMessageViewTokenFooterTests {
    ...
    @Test func format_small_count() {
        #expect(ChatMessageFooter.formatTokenCount(0) == "0 tokens")
        #expect(ChatMessageFooter.formatTokenCount(1) == "1 tokens")
        #expect(ChatMessageFooter.formatTokenCount(234) == "234 tokens")
        #expect(ChatMessageFooter.formatTokenCount(999) == "999 tokens")
    }
    ...
    @Test func format_thousands_one_decimal() {
        #expect(ChatMessageFooter.formatTokenCount(1_000) == "1.0k tokens")
        #expect(ChatMessageFooter.formatTokenCount(1_500) == "1.5k tokens")
        #expect(ChatMessageFooter.formatTokenCount(5_678) == "5.7k tokens")
        #expect(ChatMessageFooter.formatTokenCount(9_999) == "10.0k tokens")
    }
    ...
    @Test func format_tens_of_thousands() {
        #expect(ChatMessageFooter.formatTokenCount(10_000) == "10k tokens")
        #expect(ChatMessageFooter.formatTokenCount(50_000) == "50k tokens")
        #expect(ChatMessageFooter.formatTokenCount(234_567) == "234k tokens")
        #expect(ChatMessageFooter.formatTokenCount(999_999) == "999k tokens")
    }
    ...
    @Test func format_millions() {
        #expect(ChatMessageFooter.formatTokenCount(1_000_000) == "1.0M tokens")
        #expect(ChatMessageFooter.formatTokenCount(1_234_567) == "1.2M tokens")
        #expect(ChatMessageFooter.formatTokenCount(5_000_000) == "5.0M tokens")
    }
    ...
    @Test func footer_gated_on_positive_tokens() throws {
        ...
        #expect(source.contains("if let tokens, tokens > 0"))
    }
}