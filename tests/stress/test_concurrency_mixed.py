...
def worker_loop(worker_id: int, wenshu_home: str, result_file: str) -> None:
...
def reclaimer_loop(wenshu_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="wenshu_mixed_stress_")
    print(f"WENSHU_HOME = {home}")
