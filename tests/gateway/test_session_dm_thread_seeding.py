...
def store(tmp_path, monkeypatch):
    ...
    ~/.wenshu-hermes/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at wenshu_state import time, before pytest's WENSHU_HOME monkeypatch
    fires — the autouse fixture's WENSHU_HOME override doesn't help here.)
    """
    import wenshu_state
