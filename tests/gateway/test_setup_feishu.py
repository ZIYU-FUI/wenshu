"""Tests for _setup_feishu() in wenshu_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("wenshu_cli.config.save_env_value", side_effect=mock_save), \
         patch("wenshu_cli.config.get_env_value", side_effect=mock_get), \
         patch("wenshu_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("wenshu_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("wenshu_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("wenshu_cli.cli_output.print_header"), \
         patch("wenshu_cli.cli_output.print_info"), \
         patch("wenshu_cli.cli_output.print_success"), \
         patch("wenshu_cli.cli_output.print_warning"), \
         patch("wenshu_cli.cli_output.print_error"), \
