...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("WENSHU_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("WENSHU_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("WENSHU_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
