...
class TestLoadGatewayConfigForRunner:
    ...
    def test_scoped_reload_picks_up_default_profile_token(self, tmp_path, monkeypatch):
        ...
        monkeypatch.delenv("TELEGRAM_BOT_TOKEN", raising=False)
        # Point both wenshu_constants and gateway.run at our temp home.
        monkeypatch.setattr(hc, "get_wenshu_home", lambda: home)
        monkeypatch.setattr(run_mod, "get_wenshu_home", lambda: home)
        monkeypatch.setattr(run_mod, "_wenshu_home", home)
