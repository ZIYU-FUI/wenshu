"""Session <-> workspace grouping key (wenshu_state.workspace_key).

The key is what `wenshu sessions list --workspace` groups/filters on. It is a
...
from wenshu_state import workspace_key
