...
manipulation. Wenshu keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point WENSHU_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_wenshu_home /
    get_default_wenshu_root) instead of monkeypatching private helpers —
    ...
    WENSHU_HOME=<root>/profiles/<name> makes get_default_wenshu_root()
