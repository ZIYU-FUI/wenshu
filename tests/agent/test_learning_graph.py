...
def test_wenshu_meta_tolerates_non_dict():
    assert learning_graph._wenshu_meta({"metadata": "junk"}) == {}
    assert learning_graph._wenshu_meta({"metadata": {"wenshu": "junk"}}) == {}
    assert learning_graph._wenshu_meta({"metadata": {"wenshu": {"category": "x"}}}) == {"category": "x"}
