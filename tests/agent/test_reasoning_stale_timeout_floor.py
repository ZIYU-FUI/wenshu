...
thinking phase.  Wenshu's default cloud-stream stale detector
(``WENSHU_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``WENSHU_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
