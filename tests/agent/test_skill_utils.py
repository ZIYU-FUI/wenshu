...
def test_metadata_as_dict_with_wenshu():
    """Normal case: metadata is a dict containing wenshu keys."""
    frontmatter = {
        "metadata": {
            "wenshu": {
...
class TestParseFrontmatterBOM:
    ...
    def test_bom_config_vars_preserved(self):
        # metadata.wenshu.config drives secure setup-on-load; it must survive
