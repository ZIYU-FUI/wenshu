...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("wenshu_cli.config.get_config_path", return_value=config_path), \
             patch("wenshu_cli.config.ensure_wenshu_home"):
    ...
    def test_ensure_wenshu_home_sets_0700(self):
        home = Path(self.tmpdir) / ".wenshu-hermes"
