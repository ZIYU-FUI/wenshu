"""Tests for the ``wenshu prompt-size`` diagnostic (issue #34667)."""
...
from wenshu_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(wenshu_home, memory_text="", user_text=""):
    mem_dir = wenshu_home / "memories"
...
def _seed_skill(wenshu_home, name, description):
    skill_dir = wenshu_home / "skills" / "demo" / name
