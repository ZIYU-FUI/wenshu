"""Test the platform-branched PTY bridge import in wenshu_cli.web_server.
...
def test_web_server_uses_win_pty_bridge_on_windows():
    ...
    from wenshu_cli.win_pty_bridge import WinPtyBridge
    ...
    from wenshu_cli.win_pty_bridge import PtyUnavailableError as WinErr
...
def test_web_server_uses_posix_pty_bridge_on_posix():
    ...
    from wenshu_cli.pty_bridge import PtyBridge as PosixBridge
    from wenshu_cli.pty_bridge import PtyUnavailableError as PosixErr
...
def test_pty_bridge_import_block_is_platform_branched():
    ...
    #       try:
    #           from wenshu_cli.win_pty_bridge import WinPtyBridge as PtyBridge, ...
    #       except ImportError:
    #           PtyBridge = None
    #           ...
    #   else:
    ...
    assert "from wenshu_cli.win_pty_bridge import" in src
    assert "from wenshu_cli.pty_bridge import" in src
