"""Tests for the specifier module + `wenshu kanban specify` CLI surface.
...
from wenshu_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `wenshu kanban …` argparse surface directly."""
