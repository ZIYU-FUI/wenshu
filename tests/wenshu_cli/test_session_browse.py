"""Tests for the interactive session browser (`wenshu sessions browse`).
...
from wenshu_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """wenshu sessions browse should be parseable."""
