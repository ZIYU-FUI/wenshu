...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from wenshu_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in WENSHU_OVERLAYS
        overlay = WENSHU_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify wenshu doctor recognizes Xiaomi env vars."""
