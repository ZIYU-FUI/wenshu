...
The main() function in wenshu_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `wenshu -c model`
...
def _build_parser():
    """Build a minimal replica of the wenshu top-level parser."""
