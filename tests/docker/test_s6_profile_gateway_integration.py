...
The unit tests in tests/wenshu_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned wenshu-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/wenshu")
from wenshu_cli.service_manager import S6ServiceManager
