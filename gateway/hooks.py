...
Hooks are discovered from ~/.wenshu-hermes/hooks/ directories, each containing:
...
HOOKS_DIR = get_wenshu_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"wenshu_hook_{hook_name}"
