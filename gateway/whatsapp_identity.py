...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$WENSHU_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_wenshu_dir("platforms/whatsapp/session", "whatsapp/session")
