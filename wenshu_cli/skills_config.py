"""
Skills configuration for 文枢.
`wenshu skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.wenshu-hermes/config.yaml under:
...
from wenshu_cli.config import cfg_get, load_config, save_config
from wenshu_cli.colors import Colors, color
from wenshu_cli.platforms import PLATFORMS as _PLATFORMS
