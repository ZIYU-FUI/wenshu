"""Client for uploading ``wenshu debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``wenshu debug share``.
...
NAS_BASE = os.environ.get(
    "WENSHU_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "wenshu-agent/debug-share"
