...
Usage:
    wenshu pairing list              # Show all pending + approved users
    wenshu pairing approve <platform> <code>  # Approve a pairing code
    wenshu pairing revoke <platform> <user_id> # Revoke user access
    wenshu pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle wenshu pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: wenshu pairing {list|approve|revoke|clear-pending}")
        print("Run 'wenshu pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.wenshu-hermes/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'wenshu pairing list' to see pending codes.\n")
