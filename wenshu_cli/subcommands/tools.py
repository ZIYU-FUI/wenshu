"""``wenshu tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'wenshu tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # wenshu tools list [--platform cli]
    ...
    # wenshu tools disable <name...> [--platform cli]
    ...
    # wenshu tools enable <name...> [--platform cli]
