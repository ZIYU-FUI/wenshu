...
Invoked by ``wenshu kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the 文枢 board.
...
def _profile_author() -> str:
    """Mirror of ``wenshu_cli.kanban._profile_author``."""
    return (
