"""Shared curses-based UI components for 文枢 CLI.

Used by `wenshu tools` and `wenshu skills` for interactive checklists.
...
def _token_score(orig: str, lower: str, token: str) -> float | None:
    ...
    A faithful port of the web fuzzy scorer and
