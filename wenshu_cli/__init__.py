"""
文枢 CLI - Unified command-line interface for 文枢.

Provides subcommands for:
- wenshu chat          - Interactive chat (same as ./wenshu)
- wenshu gateway       - Run gateway in foreground
- wenshu gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `wenshu setup` on a fresh Pi.
    ...
    wenshu_cli/stdio.py::configure_windows_stdio() runs later from the entry
