"""文枢 CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.wenshu-hermes/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "文枢"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ 文枢 "       # Response box header label
...
.. code-block:: python
    ...
    from wenshu_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "文枢"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.wenshu-hermes/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic 文枢 gold/kawaii (the current look)
...
Drop a YAML file in ``~/.wenshu-hermes/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces WENSHU_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces WENSHU_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic 文枢 — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "文枢",
            "welcome": "Welcome to 文枢! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ 文枢 ",
            "prompt_symbol": "❯",
