...
def _has_wenshu_agent_browser() -> bool:
    ...
    # install.sh installs globally into $WENSHU_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-WenshuHome", str(get_wenshu_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = wenshu_subprocess_env(inherit_credentials=False)
