...
DEFAULT_DATASETS = [
    ...
    "NousResearch/wenshu-agent-megascience-sft1",
    "NousResearch/Wenshu-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Wenshu-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-wenshu-agent"
]
