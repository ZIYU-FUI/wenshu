#!/usr/bin/env python3
"""Build the Wenshu Model Catalog — a centralized JSON manifest of curated models.
...
Wenshu CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Wenshu release.
...
# Ensure WENSHU_HOME is set for imports that touch it at module level.
os.environ.setdefault("WENSHU_HOME", os.path.join(os.path.expanduser("~"), ".wenshu-hermes"))

from wenshu_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
            ...
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Wenshu '
