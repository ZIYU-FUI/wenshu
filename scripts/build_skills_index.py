#!/usr/bin/env python3
"""Build the Wenshu Skills Index — a centralized JSON catalog of all skills.
...
`wenshu skills search/install` can use it without hitting the GitHub API.
...
# Ensure WENSHU_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Wenshu Skills Index...", flush=True)
