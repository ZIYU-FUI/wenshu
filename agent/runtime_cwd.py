...
_SESSION_CWD: ContextVar = ContextVar("WENSHU_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Wenshu
    # source tree itself, which is a legitimate workspace when the user is
    # developing Wenshu (per-surface policy for fallback-picked directories
