...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``wenshu logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Wenshu only initiates compaction in "wenshu" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping 文枢 preflight compression for codex app-server "
                "(mode=%s); 文枢 will not start thread compaction here.",
