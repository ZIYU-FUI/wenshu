...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Wenshu's web-provider config and
        ...
        # native search engine for xAI sessions instead of Wenshu's
        # configured web provider (Tavily/etc.), and those results bypass
        # Wenshu's tool-trace / citation plumbing (they arrive baked into the
