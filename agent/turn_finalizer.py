...
decomposition campaign (``~/.wenshu-hermes/plans/god-file-decomposition.md``, Phase 1
...
def finalize_turn(
    ...
    *,
    ...
    if iteration_limit_fallback:
        ...
        _kanban_task = os.environ.get("WENSHU_KANBAN_TASK")
        if _kanban_task:
            try:
    ...
    result = {
        ...
        # billing audits by callers like `wenshu -z --usage-file`.
        "service_tier": (
