...
``_check_spotify_available()`` — when the user has not run ``wenshu auth
spotify``, the tools remain registered (so they appear in ``wenshu
...
The Spotify auth flow (``wenshu auth spotify``), CLI plumbing, and docs
