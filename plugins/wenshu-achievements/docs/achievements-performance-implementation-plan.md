# Wenshu Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.wenshu-hermes/plugins/wenshu-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.wenshu-hermes/plugins/wenshu-achievements/scan_checkpoint.json`.
