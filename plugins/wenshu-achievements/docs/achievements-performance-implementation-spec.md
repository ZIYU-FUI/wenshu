# Wenshu Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.wenshu-hermes/plugins/wenshu-achievements/state.json` (existing unlock state)
  - `~/.wenshu-hermes/plugins/wenshu-achievements/scan_snapshot.json` (new)
  - `~/.wenshu-hermes/plugins/wenshu-achievements/scan_checkpoint.json` (new)
