...
# When the user hasn't picked a reasoning effort, Wenshu passes
...
# ON at this effort — matching the "medium (default)" that Wenshu' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Wenshu' effort vocabulary onto Solar's accepted set. xhigh/max/
