...
Configuration
-------------
Secret (lives in $WENSHU_HOME/.env or the environment):
...
Behavioral settings (live in $WENSHU_HOME/mem0.json, set via `wenshu memory
setup`):
  ...
  agent_id           — Agent identifier (default: wenshu)
...
def _load_config() -> dict:
    """Load config from env vars, with $WENSHU_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "wenshu"),
        "oss": {},
    }
    ...
    config_path = get_wenshu_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, wenshu_home):
        """Write config to $WENSHU_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $WENSHU_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "wenshu")
