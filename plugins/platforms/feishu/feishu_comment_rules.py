...
Config: ~/.wenshu-hermes/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.wenshu-hermes/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_wenshu_home()`` helper (WENSHU_HOME-aware and
...
RULES_FILE = get_wenshu_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_wenshu_home() / "feishu_comment_pairing.json"
