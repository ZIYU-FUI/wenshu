...
required — uses aiohttp which is already a Wenshu dependency.
...
def interactive_setup() -> None:
    ...
    ``wenshu_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Wenshu delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # wenshu_cli/setup.py::_setup_mattermost function.
