...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Wenshu gateway adapter.

    Each inbound phone number gets its own Wenshu session (multi-tenant).
...
# static dict in wenshu_cli/gateway.py, and the _send_sms dispatch in
