...
/// the per-pane metadata lives in `LayoutTreeState.panes` (keyed by
...
// MARK: - LayoutTreeState v2 (= hermes-tree-backed)

/// LayoutTreeState — the user's current pane tree + tabs.
///
...
struct LayoutTreeState: Codable, Equatable {
