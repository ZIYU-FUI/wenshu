...
struct ChatZoneView: View {
    ...
    var body: some View {
            ...
            // Removed the inner HStack .background override (= the
            // inner HStack was being squeezed to its content height
            // by the Spacer + inner HStack layout = 30 PT only =
            // the .background only applied to that strip, leaving
