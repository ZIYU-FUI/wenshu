...
//
//  refactor chat-mvvm-3layer C-1 (boss 2026-09-22 '目标 UI，业务，数据，三分离'):
//  - Domain types (ChatMessage / ChatRole / ChatSource) physically moved
//    to `Core/Chat/Domain/ChatMessage.swift`.
//  - StreamingAccumulator + StreamingTaskBox stay (= stream-callback
//    helper that lives next to the ChatViewModel that owns them).
//  - ChatViewModel stays here (= C-3 moves it).
//
