...
/// `SidebarItem` (the selection enum = book / shelf / folder /
/// reference category) lives in its own file (=
/// `SidebarItem.swift`). v1.69 cleanup extracted it from this
/// legacy 2520-LOC sidebar so the rest of wenshu
/// (= PreviewPane / WorkspaceView / ShellMiddleColumn / AppState)
/// can import the data model without pulling in this view file.
