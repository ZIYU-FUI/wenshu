...
Data file: $WENSHU_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_WENSHU_HOME = Path(os.environ.get("WENSHU_HOME", Path.home() / ".wenshu-hermes"))
DATA_DIR = _WENSHU_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
