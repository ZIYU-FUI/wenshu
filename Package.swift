...
let package = Package(
    ...
    dependencies: [
        ...
        // v0.27 ticket 027-31 (= boss 8/27 OOB 'Xcode 范式 + 用户自定义布局'):
        // second approved third-party UI library exception per AGENTS.md
        // §11.1. Selection rationale: bonsplit is the most actively-maintained
        // macOS SwiftUI tab + split-pane library (= last commit 2026-05-19,
        // 460 GitHub stars, 101 forks, MIT license, macOS-first, 120fps
        // animations + keyboard nav + drag-and-drop tab reordering). It
