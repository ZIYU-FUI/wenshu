...
import { launchWenshuDesktop } from '../store'
 ...
 * had `onClick={() => void launchWenshuDesktop()}` which swallowed
...
export default function Success() {
  ...
  return (
    <div className="wenshu-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
