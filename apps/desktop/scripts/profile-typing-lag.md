...
cd apps/desktop
XCURSOR_SIZE=24 WENSHU_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/wenshu-typing
# → /tmp/wenshu-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/wenshu-typing.before.heapsnapshot
# → /tmp/wenshu-typing.after.heapsnapshot
```
