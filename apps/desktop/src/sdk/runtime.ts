 ...
 * plugins resolve `@wenshu/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __WENSHU_PLUGIN_SDK__: sdk,
  __WENSHU_REACT__: React,
  __WENSHU_REACT_JSX__: jsxRuntime,
  __WENSHU_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@wenshu/plugin-sdk': shimUrl('__WENSHU_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__WENSHU_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__WENSHU_REACT_JSX__'),
    react: shimUrl('__WENSHU_REACT__')
  }
