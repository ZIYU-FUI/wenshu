...
const STORAGE_KEY = 'wenshu.desktop.layoutTree.v2'

writeKey('wenshu.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('wenshu.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('wenshu.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'wenshu.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'wenshu.desktop.userPlacedPanes.v1'
...
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__WENSHU_LAYOUT_TREE__ = {
    close: closeTreePane,
