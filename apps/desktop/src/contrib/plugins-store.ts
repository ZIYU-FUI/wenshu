 ...
 * `<wenshu home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'wenshu.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'wenshu.desktop.disabledPlugins.v1'
