...
const TILES_KEY = 'wenshu.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'wenshu.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __WENSHU_LAYOUT_TREE__).
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__WENSHU_SESSION_TILES__ = {
