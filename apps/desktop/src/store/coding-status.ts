...
import type { WenshuGitWorktree, WenshuRepoStatus } from '@/global'
...
export const $repoStatus = atom<WenshuRepoStatus | null>(null)
...
export const $repoWorktrees = atom<WenshuGitWorktree[]>([])
...
interface RepoStatusRefreshRequest {
  probe: (cwd: string) => Promise<WenshuRepoStatus | null>
  seq: number
  target: string
}
