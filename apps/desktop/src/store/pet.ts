...
export interface PetInfo {
  ...
  // the 文枢 "run" activity state uses the in-place running row).
 ...
 * WENSHU_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'wenshu.desktop.pet-roam.v1'
