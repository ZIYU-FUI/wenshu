...
const TAKEOVER_KEY = 'wenshu.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which 文枢 can't clear via the API — the user
 *  sees exactly what runs instead of 文枢 silently deleting their creds. */
