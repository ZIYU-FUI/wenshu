import type { WenshuReviewFile } from '@/global'
...
export function buildReviewFlatList(files: WenshuReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: WenshuReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
