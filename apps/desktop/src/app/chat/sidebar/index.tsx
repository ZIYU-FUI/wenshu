...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('wenshu:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('wenshu:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask 文枢 to
