...
import { type DroppedFile, extractDroppedFiles, WENSHU_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, WENSHU_PATHS_MIME) ? 'files' : null
