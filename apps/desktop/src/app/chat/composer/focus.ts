...
const FOCUS_EVENT = 'wenshu:composer-focus'
const INSERT_EVENT = 'wenshu:composer-insert'
const INSERT_REFS_EVENT = 'wenshu:composer-insert-refs'
const SUBMIT_EVENT = 'wenshu:composer-submit'
const VOICE_TOGGLE_EVENT = 'wenshu:composer-voice-toggle'
