...
export function getNested(obj: WenshuConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: WenshuConfigRecord, path: string, value: unknown): WenshuConfigRecord {
...
function personalityOptions(config: WenshuConfigRecord): string[] {
...
function commandProviderNames(config: WenshuConfigRecord, section: 'tts' | 'stt'): string[] {
