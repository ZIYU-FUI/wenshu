...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/wenshu'
...
// / Program Files), which buried any files 文枢 wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.wenshuDesktop` is
    ...
    const settings = window.wenshuDesktop?.settings
