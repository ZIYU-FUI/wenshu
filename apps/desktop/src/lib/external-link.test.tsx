...
const desktopWindow = window as unknown as { wenshuDesktop?: Window['wenshuDesktop'] }
const initialWenshuDesktop = desktopWindow.wenshuDesktop

function installDesktopBridge(partial: Partial<Window['wenshuDesktop']> = {}) {
  desktopWindow.wenshuDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['wenshuDesktop']
}
...
afterEach(() => {
  ...
  if (initialWenshuDesktop) {
    desktopWindow.wenshuDesktop = initialWenshuDesktop
  } else {
    delete desktopWindow.wenshuDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['wenshuDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['wenshuDesktop']['openExternal'] })
