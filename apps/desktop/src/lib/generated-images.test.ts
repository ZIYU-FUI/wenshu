  ...
  it('prefers the host-visible image path', () => {
    expect(
      generatedImageFromResult({
        ...
        host_image: '/Users/me/.wenshu-hermes/cache/images/cat.png',
        image: '/Users/me/.wenshu-hermes/cache/images/cat.png',
        success: true
      })
    ).toBe('/Users/me/.wenshu-hermes/cache/images/cat.png')
  })
