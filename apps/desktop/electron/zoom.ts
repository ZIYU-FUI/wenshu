...
export const ZOOM_STORAGE_KEY = 'wenshu:desktop:zoomLevel'
 ...
 * but forgot to emit 'wenshu:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('wenshu:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
