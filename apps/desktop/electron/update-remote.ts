 ...
 *
 * A public install can end up with `origin=git@github.com:NousResearch/wenshu-agent.git`.
...
const OFFICIAL_REPO_CANONICAL = 'github.com/nousresearch/wenshu-agent'
