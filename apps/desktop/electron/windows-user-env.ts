...
// even though a fresh shell — and the 文枢 CLI — sees it immediately. The
// desktop's WENSHU_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\wenshu. Reading
