...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @wenshu/plugin-sdk (+ react), never `@/…`
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@wenshu/shared'],
              message: 'Plugins import only @wenshu/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
