...
export default defineConfig({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\wenshu\wenshu-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@wenshu/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@wenshu/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@wenshu/shared': path.resolve(__dirname, '../shared/src'),
