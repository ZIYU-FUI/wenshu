...
def _profile_user_agent() -> str:
    """Return a ``wenshu-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from wenshu_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"wenshu-cli/{_ver}"
    except Exception:
        return "wenshu-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # wenshu-cli UA so the catalog endpoint is reachable.
